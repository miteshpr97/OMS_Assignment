  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3306/api/assignmentDetails/${reassignmentData.AssignmentID}/${reassignmentData.EmployeeID}/${assignmentData.EmployeeID_AssignTo}/reassign`,
        {
          method: "PATCH",
          headers: {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item md={4}>
              <TextField
                ...
                id="AssignDate"
                label="Assign Date"
                value = {formatDate(reassignmentData.AssignDate)}
