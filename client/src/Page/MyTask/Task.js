...
const TaskDialog = ({ open, onClose, onCreateTask }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      ...
      <DialogContent>
        <form onSubmit={handleSubmit} noValidate validated={validated}> {/* Added noValidate and validated props */}
          ...
          <div
              ...
              >
                <Button
                  ...
                  style={{ backgroundColor: "#055f85", borderColor: "#055f85", color:'white' }}
                >
                  Submit
                </Button>
              </div>
